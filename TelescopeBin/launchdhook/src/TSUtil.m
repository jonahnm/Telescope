...
int spawnRoot(NSString* path, NSArray* args, NSString** stdOut, NSString** stdErr, int (*OldSpawn)())
{
	...
	pid_t task_pid;
	int status = -200;
	int spawnError = OldSpawn(&task_pid, [path UTF8String], &action, &attr, (char* const*)argsC, NULL);
