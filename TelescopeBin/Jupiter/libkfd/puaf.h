...
static inline void puaf_helper_get_vm_map_first_and_last(u64* first_out, u64* last_out);
static inline void puaf_helper_get_vm_map_min_and_max(u64* min_out, u64* max_out);
static inline void puaf_helper_give_ppl_pages(void);
...
static inline void puaf_init(struct kfd* kfd, u64 puaf_pages, u64 puaf_method)
{
...
static inline void puaf_run(struct kfd* kfd)
{
...
static inline void puaf_cleanup(struct kfd* kfd)
{
    timer_start();
...
static inline void puaf_free(struct kfd* kfd)
{
