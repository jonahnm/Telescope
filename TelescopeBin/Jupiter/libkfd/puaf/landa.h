...
static const u64 landa_vme1_size = pages(1);
static const u64 landa_vme2_size = pages(1);
static const u64 landa_vme4_size = pages(1);

// Forward declarations for helper functions.
static inline void* landa_helper_spinner_pthread(void* arg);
...
static inline void landa_init(struct kfd* kfd)
{
...
static inline void landa_run(struct kfd* kfd)
{
...
static inline void landa_cleanup(struct kfd* kfd)
{
    struct landa_data* landa = (struct landa_data*)(kfd->puaf.puaf_method_data);
...
static inline void landa_free(struct kfd* kfd)
{
    u64 kread_page_uaddr = trunc_page(kfd->kread.krkw_object_uaddr);
    u64 kwrite_page_uaddr = trunc_page(kfd->kwrite.krkw_object_uaddr);
