 ...
 */
static const bool take_vm_map_lock = true;

// Forward declarations for helper functions.
static inline void smith_helper_init(struct kfd* kfd);
static inline void* smith_helper_spinner_pthread(void* arg);
static inline void* smith_helper_cleanup_pthread(void* arg);
static inline void smith_helper_cleanup(struct kfd* kfd);
 ...
 */
static inline void smith_init(struct kfd* kfd)
{
 ...
 */
static inline void smith_run(struct kfd* kfd)
{
 ...
 */
static inline void smith_cleanup(struct kfd* kfd)
{
 ...
 */
static inline void smith_free(struct kfd* kfd)
{
    u64 kread_page_uaddr = trunc_page(kfd->kread.krkw_object_uaddr);
    u64 kwrite_page_uaddr = trunc_page(kfd->kwrite.krkw_object_uaddr);
