...
#import <stdint.h>
#include "../../../kpf/libdimentio.h"
#include "../../../kpf/patchfinder.h"

static const char* kread_sem_open_name = "kfd-posix-semaphore";

static inline u64 kread_sem_open_kread_u64(struct kfd* kfd, u64 kaddr);
static inline u32 kread_sem_open_kread_u32(struct kfd* kfd, u64 kaddr);

static inline void kread_sem_open_init(struct kfd* kfd)
{
...
static inline void kread_sem_open_allocate(struct kfd* kfd, u64 id)
{
...
static inline bool kread_sem_open_search(struct kfd* kfd, u64 object_uaddr)
{
...
static inline void kread_sem_open_kread(struct kfd* kfd, u64 kaddr, void* uaddr, u64 size)
{
    kread_from_method(u64, kread_sem_open_kread_u64);
}

static inline void kread_sem_open_find_proc(struct kfd* kfd)
{
...
static inline void kread_sem_open_deallocate(struct kfd* kfd, u64 id)
{
    /*
...
static inline void kread_sem_open_free(struct kfd* kfd)
{
    /*
