...
static inline void kwrite_sem_open_init(struct kfd* kfd)
{
...
static inline void kwrite_sem_open_allocate(struct kfd* kfd, u64 id)
{
    if (id == 0) {
...
static inline bool kwrite_sem_open_search(struct kfd* kfd, u64 object_uaddr)
{
    /*
     * Just piggyback.
     */
...
static inline void kwrite_sem_open_kwrite(struct kfd* kfd, void* uaddr, u64 kaddr, u64 size)
{
    /*
     * Just piggyback.
     */
...
static inline void kwrite_sem_open_find_proc(struct kfd* kfd)
{
    /*
...
static inline void kwrite_sem_open_deallocate(struct kfd* kfd, u64 id)
{
    /*
...
static inline void kwrite_sem_open_free(struct kfd* kfd)
{
    /*
