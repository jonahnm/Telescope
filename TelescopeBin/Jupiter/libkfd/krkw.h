...
static inline void krkw_helper_init(struct kfd* kfd, struct krkw* krkw);
static inline int krkw_helper_grab_free_pages(struct kfd* kfd);
static inline void krkw_helper_run_allocate(struct kfd* kfd, struct krkw* krkw);
static inline void krkw_helper_run_deallocate(struct kfd* kfd, struct krkw* krkw);
static inline void krkw_helper_free(struct kfd* kfd, struct krkw* krkw);
...
static inline void krkw_init(struct kfd* kfd, u64 kread_method, u64 kwrite_method)
{
...
static inline int krkw_run(struct kfd* kfd)
{
...
static inline void krkw_kread(struct kfd* kfd, u64 kaddr, void* uaddr, u64 size)
{
    kfd->kread.krkw_method_ops.kread(kfd, kaddr, uaddr, size);
}

static inline void krkw_kwrite(struct kfd* kfd, void* uaddr, u64 kaddr, u64 size)
{
    kfd->kwrite.krkw_method_ops.kwrite(kfd, uaddr, kaddr, size);
}

static inline void krkw_free(struct kfd* kfd)
{
...
static inline void krkw_helper_find_kfd_offsets(struct kfd* kfd) {
